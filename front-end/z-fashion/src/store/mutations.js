...
// quantity cart
export const SET_QUANTITY_CART = (state, quantity_cart) => {
  state.quantity_cart = quantity_cart;
};
export const DELETE_QUANTITY_CART = (state, quantity_cart) => {
  state.quantity_cart = state.quantity_cart - quantity_cart;
};
